...
@section('title','edit_technical_Description')
							...
							<div class="row">
								<div class="col-lg-9">
									...
									<div class="kt-portlet">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">
													Update_Bike_Technical_Specification
												</h3>
											</div>
										</div>
										...
										<form action="{{Route('updateBikeDescription',[$showeditdescript->id])}}" method="post" class="kt-form">
											{{csrf_field()}}
											<div class="kt-portlet__body">
												<div class="kt-section kt-section--first">
													<div class="form-group">
														<label>Parts</label>
														<input type="text" class="form-control" name="part" value="{{$showeditdescript->parts}}">
															@if($errors->has('part'))
													...
													<div class="col-lg-9 col-md-9 col-sm-12">
														<textarea class="form-control" name="memo"  rows="8">{{$showeditdescript->description}}</textarea>
														@if($errors->has('memo'))
														<span style="color: red">
															{{$errors->First('memo')}}
														</span>
